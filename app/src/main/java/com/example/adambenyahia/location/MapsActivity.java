...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    void LoadPockemon(){
        ...
        ListPockemons.add(new Pockemon(  R.drawable.salameche, "Salameche", "Salameche vit au Japon", 55, 37.7789994893035, -122.401846647263));
        ListPockemons.add(new Pockemon(  R.drawable.bulbizarre ,"Bulbizarre",  "Bulbizarre vit en Amérique", 90.5, 37.7949568502667,  -122.410494089127));
        ListPockemons.add(new Pockemon(  R.drawable.carapuce, "Carapuce",  "Carapuce vit en irak", 33.5, 37.7816621152613,  -122.41225361824  ));
